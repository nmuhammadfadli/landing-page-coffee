<section class="bg-primary-green py-20 relative overflow-hidden">
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <span class="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-bold tracking-[0.2em] uppercase bg-white/10 border border-white/20 text-accent-gold rounded-full mb-6">
            {{ t('Hubungan Dagang Langsung', 'DIRECT TRADE PARTNERSHIP') }}
        </span>
        ...
        <p class="text-white/80 text-base sm:text-lg leading-relaxed mb-10 max-w-2xl mx-auto font-light">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
            ...
            <a
                href="/catalog"
                class="inline-flex items-center gap-2 border-2 border-white/30 text-white hover:border-white hover:bg-white/10 font-semibold px-8 py-4 rounded-xl transition-all duration-300 text-sm tracking-wider"
            >
        ...
        <div class="max-w-md mx-auto">
            <p class="text-white/70 text-sm mb-4 font-light">
            ...
            <form
                ...
                class="flex gap-2 bg-white/5 border border-white/10 p-1.5 rounded-2xl backdrop-blur-sm"
            >
                ...
                <input
                    ...
                    class="flex-1 px-4 py-3 bg-transparent border-0 text-white placeholder-white/50 focus:outline-none focus:ring-0 text-sm"
                >
                <button
                    type="submit"
                    x-bind:disabled="submitting"
                    class="bg-accent-gold hover:bg-accent-gold/90 text-primary-green font-bold px-6 py-3 rounded-xl text-xs uppercase tracking-widest transition-all duration-300 disabled:opacity-50"
                >
            ...
            <p x-show="message" x-text="message" class="text-accent-gold/80 text-xs mt-3 font-semibold"></p>
        </div>
    </div>
</section>
